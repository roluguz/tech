...
<?php include('session.php'); ?>
    <body>
        ...
        <div class="container-fluid">
            <div class="row-fluid">       
        <?php // este es como esta include('location_slidebar.php'); ?>			
                ...
                <div class="span6" id="">
					...
					<div class="empty">
                        <div class="alert alert-success alert-dismissable">
                            ...
                            <i class="icon-info-sign"></i>  <strong>Note!:</strong> Marcar si quieres eliminar
                        </div>
                    </div>
                        ...
                        <div id="block_bg" class="block">
                            <div class="navbar navbar-inner block-header">
							   <div class="muted pull-left"><i class="icon-reorder icon-building"></i> location List</div>                       
								...
								<?php 
								$my_location = mysqli_query($cnx,"select * from stlocation ")or die(mysqli_error());
                                ...
                                <div class="span12">
									<form action="delete_location.php" method="post">
									  ...
									  <thead>
										...
										<tbody>
										<?php
										$location_query = mysqli_query($cnx,"select * from stlocation")or die(mysqli_error());
