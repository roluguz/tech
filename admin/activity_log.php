...
<?php include('session.php'); ?>
    <body>
        ...
        <div class="container-fluid">
            <div class="row-fluid">
			<?php // este es como esta include('activity_log_slidebar.php'); ?>			
			<?php include('device_sidebar.php'); ?>	        
				...
				<?php	
	             $count_log=mysqli_query($cnx, "select * from activity_log");
                            ...
                            <div class="block-content collapse in">
								...
								<form action="delete_log.php" method="post">
									...
									<?php include('modal_delete.php'); ?>
                              		...
                              		<?php
										$query = mysqli_query($cnx, "select * from  activity_log 
