...
<body>
	...
	<div class="row-fluid">
		<?php // este es como esta include('newdevice_slidebar.php'); ?>			
		...
		<div class="span9" id="content">
				...
				<div id="block_bg" class="block">
					<div class="navbar navbar-inner block-header">
						 <div class="muted pull-left"><i class="icon-check"></i>&nbsp;Listado dispositivos nuevos</div>
						 <div class="muted pull-right">
								Cantidad dispositivos nuevo(s): <span class="badge badge-info"><?php  echo $count; ?></span>
						 </div>
					</div>					
					<h4 id="sc">Listado dispositivos nuevos
						...
						<?php	
						 ...
						 ORDER BY stdevice.id DESC");
								 $count = mysqli_num_rows($count_item);
									 ?>					
							<li class="">
								<a href="newKeyboard.php">Keyboard&nbsp;
						...
						<?php	
						 ...
						 ORDER BY stdevice.id DESC");
								 $count = mysqli_num_rows($count_item);
									 ?>
						<li class="">
							<a href="newpower_cords.php">Power Cord&nbsp;
								<span class="label label-default"> <?php echo $count;?></span>
							</a>
						</li>
						<?php	
					...
					<tr>
						...
						<td>
							<div class="alert alert-success">
								...
								<strong><?php echo $row['dev_status']; ?></strong>
							</div>
						</td>		
					</tr>				
					<?php } ?>   
