    ...
    <ul class="nav nav-list bs-docs-sidenav nav-collapse collapse">
      <li> 
        <a href="dashboard.php">
          <i class="icon-chevron-right"></i><i class="icon-home"></i>&nbsp;Inicio
        </a> 
      </li>
        ...
        <ul id="bs" class="collapse">						
          <li class="">
            <a href="device_stocks.php">
              ...
              <i class="icon-desktop"></i> Equipos / Stocks
            </a>
          </li>
          <li class="">
            <a href="dev_name.php">
              <i class="icon-chevron-right"></i>
              <i class="icon-folder-open-alt"></i> Tipo de Equipo
            </a>
          </li> 
          <li>
            <a href="newdevice.php">
              <i class="icon-chevron-right"></i>
              <i class="icon-laptop"></i> Asignar&nbsp;<span class="label label-success">Nuevo</span>&nbsp;Equipo
          ...
          <li>
            <a href="damage.php">
              <i class="icon-chevron-right"></i>
              <i class="icon-laptop"></i> Equipos Da&#241;ados
              <?php if($not_read1 == '0'){
              }else{ ?>
          ...
          <a href="dump_device.php">
            <i class="icon-chevron-right"></i>
            <i class="icon-remove-sign"></i> Equipos Deshechados          
        ...
        <ul id="bs1" class="collapse">						
          <li class="">
            <a href="device_location.php">
              <i class="icon-chevron-right"></i>
              <i class="icon-map-marker"></i> Ubicacion Equipos
            </a>
          </li>
          <li class=""> 
            <a href="location.php">
              <i class="icon-chevron-right"></i>
              <i class="icon-sitemap"></i> Agregar Ubicacion
            </a>
          </li>
        </ul>
      </li>						
        ...
        <ul id="bs2" class="collapse">						
          <li class="">
            <a href="client_user.php">
              ...
              </i><i class="icon-user"></i>&nbsp;Personal Tecnico
            </a>              
          </li>
          <li class="">
            <a href="admin_user.php">
              <i class="icon-chevron-right"></i>
              <i class="icon-user"></i>&nbsp;Usuario de Sistema
            </a>
          </li>
        </ul>
      </li>
      ...
      <li>						
        <a href="javascript:;" role="button" class="dropdown-toggle" data-toggle="collapse" data-target="#bs3">
          <i class="icon-chevron-right"></i>
          <i class="icon-book"></i>&nbsp;Registros de Sistema
          <div class="muted pull-right"><i class="caret"></i></div>
        </a>
        <ul id="bs3" class="collapse">						
          <li class="">
            <a href="activity_log.php">
              <i class="icon-chevron-right"></i>
              <i class="icon-file"></i> Registro de Actividades
            </a>
          </li>
          <li class="">
            <a href="user_log.php">
              <i class="icon-chevron-right"></i>
              <i class="icon-file"></i> Registro de Usuarios
            </a>
          </li>
        </ul>
      </li>					
      ...
      <li class="">
        ...
        <ul id="bs4" class="collapse">
          <li>
            <a href="#myModal" data-toggle="modal" tabindex="1">
              <i class="icon-chevron-right"></i>
              <i class="icon-search"></i>&nbsp;Equipo en la Ubicacion
            </a>
          </li>
          <li>
            <a href="#myModal1" data-toggle="modal" tabindex="-1" >
              <i class="icon-chevron-right"></i>
              <i class="icon-search"></i>&nbsp;Todos los Equipos
            </a>
          </li>
        </ul>
      </li>
