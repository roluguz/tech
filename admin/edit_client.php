...
<?php $get_id = $_GET['id']; ?>
    <body>
        ...
        <div class="container-fluid">
            <div class="row-fluid">
			<?php // este es como esta include('client_user_slidebar.php'); ?>			
			<?php include('device_sidebar.php'); ?>		        
				<div class="span3" id="adduser">
				<?php include('edit_client_form.php'); ?>		   			
				</div>
				<?php	
	             $count_user=mysqli_query($cnx, "select * from client");
                            ...
                            <div class="block-content collapse in">
								...
								<form action="delete_client.php" method="post">
									...
									<?php include('modal_delete.php'); ?>
										...
										<tbody>
													<?php
													$user_query = mysqli_query($cnx, "select * from client")or die(mysqli_error());
