...
<?php include('session.php'); ?>
    <body>
        ...
        <div class="container-fluid">
            <div class="row-fluid">>
        			<?php // este es como esta include('user_slidebar.php'); ?>			
			<?php include('device_sidebar.php'); ?>	
				...
				<?php	
	             $count_user=mysqli_query($cnx,"select * from admin");
                            ...
                            <div class="block-content collapse in">
								...
								<form action="delete_users.php" method="post">
									...
									<?php include('modal_delete.php'); ?>
										...
										<tbody>
													<?php
													$user_query = mysqli_query($cnx,"select * from admin")or die(mysqli_error());
