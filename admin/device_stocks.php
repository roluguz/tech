...
<body>
	<?php include('navbar.php'); ?>
			...
			<div class="span9" id="content">
									 <div class="row-fluid">
				 <a href="add_Device.php" class="btn btn-info"  id="add" data-placement="right" title="Click to Add Device" ><i class="icon-plus-sign icon-large"></i> Nuevo Dispositivo</a>
			 ...
			 LEFT JOIN device_name ON stdevice.dev_id=device_name.dev_id");
				 ...
				 <div id="block_bg" class="block">
											<div class="navbar navbar-inner block-header">
													 <div class="muted pull-left"><i class="icon-reorder icon-large"></i> 
													Listado existencias de dispositivos&nbsp;&nbsp;
													<?php
											 ...
											 ?>
												...
												<div class="muted pull-right">
													Número de dispositivos: <span class="badge badge-info"><?php  echo $count; ?></span>
												</div>
						</div>						  
	...
	<td><?php
		...
		<td><?php
			 $device_query1 = mysqli_query($cnx, "select * from stdevice ")or die(mysqli_error());
