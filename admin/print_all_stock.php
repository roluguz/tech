        ...
        <div class="row-fluid">
          <div class="col-lg-12">
              <div class="alert alert-success alert-dismissable">
               ...
               <strong> Todas las Existencias</strong>
              </div>
          </div>
        </div>
      </div>
        ...
        <div class="row-fluid">
          <div class=WordSection1>
            ...
            <span style='font-size:14.0pt;font-family:"Times New Roman","serif"'>
              <img width=356 height=130 id="Picture 1" src="print-list-inventory_files/image001.png">
            </span></b>
            </p>
            <p class=MsoNormal align=center style='margin-bottom:0in;margin-bottom:.0001pt;
            text-align:center;line-height:normal'><b><span style='font-size:14.0pt;
            font-family:"Times New Roman","serif"'>INVENTARIO DE RECURSOS TECNOL&Oacute;GICOS</span></b></p>
            <!--
            <p class=MsoNormal align=center style='margin-bottom:0in;margin-bottom:.0001pt;
              ...
              <div class="container-fluid">
                <div class="row-fluid">
                  <div class="pull-left"> 
                    ...
                    <div class="pull-right">
                      <div class="empty">
                        <p class=MsoNormal style='margin-bottom:0in; margin-left:-110px; margin-top:-30px; margin-bottom:.0001pt;line-height:
                             normal'>
                          <span style='font-size:12.0pt;mso-bidi-font-size:11.0pt;font-family:"Times New Roman","serif"'>
                            <a href="#" onclick="window.print()" class="btn btn-info" id="print" data-placement="top" title="Click to Print">
                              <i class="icon-print icon-large"></i> Imprimir
                            </a>
                          </span>
                        </p>
                        ...
                        <p class=MsoNormal style='margin-bottom:0in; margin-top:-30px; margin-bottom:.0001pt;line-height:normal'>
                          <span style='font-size:12.0pt;mso-bidi-font-size:11.0pt;font-family:"Times New Roman","serif"'>
                            <a id="return" data-placement="top" class="btn btn-success" title="Click to Return" href="device_stocks.php">
                    ...
                    <?php
                        $device_query = mysqli_query($cnx, "select * from stdevice 
                    ...
                    <?php	
                                 $count_item=mysqli_query($cnx, "select * from stdevice 
                    ...
                    $new = mysqli_query($cnx, "select * from stdevice 
                             LEFT JOIN device_name ON stdevice.dev_id=device_name.dev_id
                             where dev_status = 'Used'")or die(mysqli_error());
                    $count = mysqli_num_rows($new);		                                               
                    ?>  
                      <td width=171 valign=top style='width:128.35pt;border-top:none;border-left:
                      none;border-bottom:solid windowtext 1.0pt;border-right:solid windowtext 1.0pt;
                    ...
                    <table class=MsoTableGrid border=0 cellspacing=0 cellpadding=0
                          ...
                          mso-padding-alt:0in 5.4pt 0in 5.4pt;mso-border-insideh:none;mso-border-insidev:none'>
                      ...
                      ?>
                       <tr style='mso-yfti-irow:1;height:17.85pt'>
                        ...
                        height:17.85pt'>
                          ...
                          <?php echo $row['firstname']." ".$row['lastname'];  ?><o:p></o:p></span></u></b></p>
                        </td>
                        <td width=376 valign=top style='width:281.85pt;padding:0in 5.4pt 0in 5.4pt;
                        height:17.85pt'>
                          <p class=MsoNormal align=center style='margin-bottom:0in;margin-bottom:.0001pt;
